...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="mb-3"><label class="form-label">Images</label><input type="file" name="images[]" class="form-control" multiple accept="image/*">
            <?php if (!empty($accessory_images)): ?>
            <p class="small text-muted mt-1">Current: <?= count($accessory_images) ?> image(s)</p>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    $('#accBrand').change(function(){
        var bid = $(this).val();
        if (!bid) {
            $('#accModel').html('<option value="">None</option>');
            return;
        }
